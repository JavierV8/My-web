        ...
        <>
            <AboutStyle isMobile={isMobile}>
                ...
                <div className="about-text">
                    ...
                    <p>Of all thecnologies i have lerned JavaScript and web thecnologies in general are the ones that have attracted me the most, that why I decided to expecialice in JavaScript. Now I spend countless hours writing JavaScript for the company I work for and in the evenings for open source projects. I feel like I achieved my goal of becoming a competent programmer, but in thecnology there is always the need to keep up just like everyone else, that's why I contribute in open source porjects in which it is a challenge for me.</p>
                    <p>When I’m not coding, I’m running or skiing, I did some races in the past of both. I love mountains and snow but it catches my attention more and more the beach and the sun, am I getting old? I am motivated to go to the gym before work to get fit and healthy. NO WAY! Im kidding! I told you I like my bed more than I like most people! but when I’m not coding, running or skiing I go to the gym. I believe this is all! well I olso do love food, also represents me! but because I am getting old and boring, I try to eat healthy...</p>
                </div>
